...
func (o *Options) run(ctx context.Context) {
	...
	o.serviceOptions.Completed().Apply(&service.ServiceConfig)
	o.controllerOptions.Completed().Apply(&service.ServiceConfig.ControllerOptions)
	o.reconcileOptions.Completed().Apply(&service.ServiceConfig.IgnoreOperationAnnotation)
